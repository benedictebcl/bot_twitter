...
select_5_journalists_random = ARRAY.sample(5)

puts select_5_journalists_random

def tweet_5 (select_5_journalists_random)
  5.times do |x|
    login_twitter.update("Bonjour #{select_5_journalists_random[x]}, pour information la quiche au pesto ne fait pas partie des apports caloriques quotidien. Merci pour ce que vous faites")
  end
end

tweet_5(select_5_journalists_random)
